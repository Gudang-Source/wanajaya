		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<a href="<?=base_URL()?>admin/ektp_baru/<?=$w->nik?>" class="btn btn-xs btn-success " title="REKAM E-KTP BARU"><i class="fa fa-file"></i></a>

						<a href="<?=base_URL()?>admin/ektp_cetak/<?=$w->nik?>" class="btn btn-xs btn-danger " title="E-KTP HILANG"><i class="fa fa-file"></i></a>
					</td>
				</tr>
