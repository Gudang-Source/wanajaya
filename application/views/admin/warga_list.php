...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title">
			<a href="<?=base_URL()?>admin/warga_tambah" class="btn btn-primary "><i class="fa fa-plus"></i>&nbsp; Tambah</a>
		</h3>
		</div>
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				?>
					...
					<tr>
						...
						<td align="center">
							<a href="<?=base_URL()?>admin/warga_edit/<?=$w->nik?>" class="btn btn-xs btn-warning " title="Edit Data"><i class="fa fa-edit"></i></a>
							<a href="<?=base_URL()?>admin/warga_hapus/<?=$w->nik?>" onclick="return confirm('Anda yakin ingin menghapus Data Warga ini?')" class="btn btn-xs btn-danger " title="Hapus Data"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
