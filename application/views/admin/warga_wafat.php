...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?=base_URL()?>admin/skematian" ><i class="fa fa-file"></i>&nbsp; Pembuatan Surat Kematian</a></li>
			<li class="active"><i class="fa fa-user-times"></i>&nbsp; Warga Telah Wafat</li>
		</ol>
	</section>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<!-- form start -->
					<?=form_open_multipart('admin/warga_wafat', 'role="form"')?>
					<div class="row">
						<div class="col-md-3">
							<div class="box-body">
						...
						<div class="col-md-3">
							<div class="box-body">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="kondisi" value="WAFAT" readonly>
								</div>
							</div>
						</div>
					...
					<div class="box-footer">
						...
						<a href="<?=base_URL()?>admin/skematian" class="btn btn-warning pull-right">Batal</a>
					</div>
				<?=form_close()?>
					<!-- form end -->
				</div>
