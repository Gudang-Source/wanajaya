...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			 Pembuatan Surat Domisili Warga
			<small>DESA MULYOAGUNG</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?=base_URL()?>admin2/dashboard" ><i class="fa fa-home"></i>&nbsp; Home</a></li>
			<li class="active"><i class="fa fa-file-text"></i>&nbsp;Pembuatan Surat Domisili</li>
		</ol>
	</section>
		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<a href="<?=base_URL()?>admin2/cetak_domisili/<?=$w->nik?>" class="btn btn-xs btn-success " title="Cetak Domisili"><i class="fa fa-file-text"></i></a>
					</td>
				</tr>
