...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><i class="fa fa-id-card"></i>&nbsp;Pembuatan Surat Pengantar E-KTP</li>
		</ol>
	</section>
		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<a href="<?=base_URL()?>admin2/ektp_baru/<?=$w->nik?>" class="btn btn-xs btn-success " title="REKAM E-KTP BARU"><i class="fa fa-file"></i></a>

						<a href="<?=base_URL()?>admin2/ektp_cetak/<?=$w->nik?>" class="btn btn-xs btn-primary " title="E-KTP HILANG"><i class="fa fa-file"></i></a>
					</td>
				</tr>
