...
<head>
  ...
  <link rel="stylesheet" href="<?=base_URL()?>assets/css/AdminLTE.min.css">
    ...
    <?php
    $usr = $this->db->get_where('tbl_admin2', array('nid' => $this->session->userdata('nid')))->row_array();
    $foto = 'default.jpg';
           ...
           <ul class="nav navbar-nav">
             ...
             <li class="dropdown user user-menu">
               <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                 ...
                 <span class="hidden-xs"><?=$usr['nama_admin2']?></span>
               </a>
               ...
               <ul class="dropdown-menu">
                 ...
                 <li class="user-header">
                   ...
                   <p>
                    <strong><?=$usr['nama_admin2']?></strong>
                    <small>ADMIN PENGELOLA</small>
                  </p>
                </li>
                ...
                <li class="user-footer">
                 <div class="pull-left">
                   <a href="<?=base_URL()?>admin2/profil_saya" class="btn btn-default btn-flat">Profil Saya</a>
                 </div>
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
       ...
       <li <?php if($this->uri->segment(2)=="dashboard") { echo 'class="active"'; } ?>>
         <a href="<?=base_URL()?>admin2/dashboard"><i class="fa fa-home"></i> <span>Home</span></a>
       </li>
       <li <?php if($this->uri->segment(2)=="warga" || $this->uri->segment(2)=="warga_tambah" || $this->uri->segment(2)=="warga_edit" || $this->uri->segment(2)=="admin2" || $this->uri->segment(2)=="admin2_tambah" || $this->uri->segment(2)=="admin2_edit" || $this->uri->segment(2)=="kk"|| $this->uri->segment(2)=="kk_tambah" || $this->uri->segment(2)=="kk_edit" || $this->uri->segment(2)=="pendatang"|| $this->uri->segment(2)=="pendatang_tambah" || $this->uri->segment(2)=="pendatang_edit") { echo 'class="treeview active"'; } else { echo 'class="treeview"'; } ?>>
        ...
        <ul class="treeview-menu">
          <li <?php if($this->uri->segment(2)=="warga" || $this->uri->segment(2)=="warga_tambah" || $this->uri->segment(2)=="warga_edit") { echo 'class="active"'; } ?>>
            <a href="<?=base_URL()?>admin2/warga"><i class="fa fa-users"></i>Warga</a> 
          </li>
          <li <?php if($this->uri->segment(2)=="kk" || $this->uri->segment(2)=="kk_tambah" || $this->uri->segment(2)=="kk_edit") { echo 'class="active"'; } ?>>
            <a href="<?=base_URL()?>admin2/kk"><i class="fa fa-book"></i>Kartu Keluarga</a> 
          </li>
          <li <?php if($this->uri->segment(2)=="pendatang" || $this->uri->segment(2)=="pendatang_tambah" || $this->uri->segment(2)=="pendatang_edit") { echo 'class="active"'; } ?>>
            <a href="<?=base_URL()?>admin2/pendatang"><i class="fa fa-users"></i>Pendatang</a> 
          </li>
          <li <?php if($this->uri->segment(2)=="admin2" || $this->uri->segment(2)=="admin2_tambah" || $this->uri->segment(2)=="admin2_edit") { echo 'class="active"'; } ?>>
            <a href="<?=base_URL()?>admin2/admin2"><i class="fa fa-user"></i>Admin Pengelola</a>
          </li>
        </ul>
      </li>
      <li <?php if($this->uri->segment(2)=="ektp") { echo 'class="active"'; } ?>>
        <a href="<?=base_URL()?>admin2/ektp"><i class="fa fa-id-card"></i> <span>Pengantar E-KTP</span></a>
      </li>
      <li <?php if($this->uri->segment(2)=="domisili") { echo 'class="active"'; } ?>>
        <a href="<?=base_URL()?>admin2/domisili"><i class="fa fa-file-text"></i> <span>Keterangan Domisili</span></a>
      </li>
      <li <?php if($this->uri->segment(2)=="pindah") { echo 'class="active"'; } ?>>
        <a href="<?=base_URL()?>admin2/pindah"><i class="fa fa-exchange"></i> <span>Pindah Tempat</span></a>
      </li>
      <li <?php if($this->uri->segment(2)=="skematian") { echo 'class="active"'; } ?>>
        <a href="<?=base_URL()?>admin2/skematian"><i class="fa fa-user-times"></i> <span>Surat Kematian</span></a>
      </li>
      <li class="header">MENU PENGGUNA</li>
      <li <?php if($this->uri->segment(2)=="profil_saya") { echo 'class="active"'; } ?>>
        <a href="<?=base_URL()?>admin2/profil_saya"><i class="fa fa-user-circle text-aqua"></i> <span>Profil Saya</span></a>
      </li>
