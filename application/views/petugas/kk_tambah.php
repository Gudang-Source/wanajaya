...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?=base_URL()?>admin2/kk" ><i class="fa fa-book"></i>&nbsp; Data KK</a></li>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<!-- form start -->
					<?=form_open_multipart('admin2/kk_tambah', 'role="form"')?>
					<div class="row">
						<div class="col-md-3">
							<div class="box-body">
					...
					<div class="box-footer">
						...
						<a href="<?=base_URL()?>admin2/kk" class="btn btn-warning btn-flat pull-right">Batal</a>
					</div>
					<?=form_close()?>
					<!-- form end -->
				</div>
