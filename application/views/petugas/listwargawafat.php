			...
			<table id="example1" class="table table-bordered table-striped">
				...
				?>
					...
					<tr>
						...
						<td align="center">
							<a href="<?=base_URL()?>admin2/cetak_suratkematian/<?=$w->nik?>" class="btn btn-xs btn-success " title="Print Surat Kematian"><i class="fa fa-file"></i></a>
							<a href="<?=base_URL()?>admin2/returnwafat/<?=$w->nik?>" class="btn btn-xs btn-danger " title="Salah Input data"><i class="fa fa-refresh"></i></a>
							</td>
						</tr>
