...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			 Pembuatan Surat Pindah Warga
			<small>DESA MULYOAGUNG</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?=base_URL()?>admin2/dashboard" ><i class="fa fa-home"></i>&nbsp; Home</a></li>
			<li class="active"><i class="fa fa-user-times"></i>&nbsp;Pembuatan Surat Pindah</li>
		</ol>
	</section>
...
<div class="box box-primary">
	...
	<h3 class="box-title">
			<a href="<?=base_URL()?>admin2/listpindah" class="btn btn-primary "><i class="fa fa-file-text"></i>&nbsp; LIHAT DATA WARGA TELAH PINDAH</a>
		</h3>
		</div>
		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<a href="<?=base_URL()?>admin2/warga_pindah/<?=$w->nik?>" class="btn btn-xs btn-danger " title="Ubah Kondisi"><i class="fa fa-star"></i></a>
					</td>
				</tr>
