...
?>
<?=form_open_multipart('admin2/profil_saya', 'role="form"')?>
<div class='row'>
	<div class='col-md-3'>
		<div class='box box-primary'>
			<div class='box-body box-profile'>
				...
				<h3 class='profile-username text-center'><?=$ps['nama_admin2']?></h3>
					...
					<div class="col-md-12">
						<div class="box-body">
							<div class="form-group">
								<label>No ID</label>
								<input type="text" class="form-control" name="nid" value="<?=$ps['nid']?>" maxlength="20" placeholder="No ID" readonly>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nama_admin2" value="<?=$ps['nama_admin2']?>" maxlength="30" placeholder="Nama Admin">
							</div>
						</div>
					</div>
