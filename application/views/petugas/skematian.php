...
<div class="box box-primary">
	...
	<h3 class="box-title">
			<a href="<?=base_URL()?>admin2/listwargawafat" class="btn btn-primary "><i class="fa fa-file-text"></i>&nbsp; LIHAT DATA WARGA TELAH WAFAT</a>
		</h3>
		</div>
		...
		<table id="example1" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center">
						<a href="<?=base_URL()?>admin2/warga_wafat/<?=$w->nik?>" class="btn btn-xs btn-danger " title="Ubah Kondisi"><i class="fa fa-star"></i></a>
					</td>
				</tr>
